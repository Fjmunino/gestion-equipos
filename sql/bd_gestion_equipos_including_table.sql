...
-- Volcando estructura de base de datos para gestion_equipos
CREATE DATABASE IF NOT EXISTS `gestion_equipos` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `gestion_equipos`;
...
-- Volcando datos para la tabla gestion_equipos.team: ~1 rows (aproximadamente)
DELETE FROM `team`;
